...
export const CreateCategoryCouponSchema = z
  .object({
    name: z
      .string()
      .min(1, '쿠폰명을 입력해주세요.')
    ...
    // Category 쿠폰은 categoryId 필수
    categoryId: z.number().int('카테고리 ID는 정수여야 합니다.'),
  })
...
export class CreateCategoryCouponDto extends createZodDto(
  CreateCategoryCouponSchema,
) {}
